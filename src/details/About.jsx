...
const About = () => {
  return (
    ...
    <div className='about'>
      ...
      <hr />
      <p>I have experience in every stage of the product and project management life cycle and consider myself to be a committed, effective, and passionate professional.
...
<div className="my-services">
  ...
  <p>Every customer wants a seamless digital experience with personalized service. Digital presence is handy for customer satisfaction</p>
  </div>
  <div className="service">
